...
public class CocktailService {
    ...
    public List<CocktailResource> getCocktails(String search) {
        ...
        List<CocktailResource> cocktailResources = mergeCocktails(cocktailDBResponse.getDrinks());
    ...
    public List<CocktailResource> mergeCocktails(List<CocktailDBResponse.DrinkResource>drinks){
        ...
        Map<String, CocktailEntity> allEntityMap=drinks.stream().map(drinkResource->{
            ...
            if(cocktailEntity==null){
                ...
                newCocktailEntity.setStrImageSource(drinkResource.getStrImageSource());
                newCocktailEntity.setStrInstructions(drinkResource.getStrInstructions());
                newCocktailEntity.setStrGlass(drinkResource.getStrGlass());
