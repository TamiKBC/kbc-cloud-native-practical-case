package com.ezgroceries.shoppinglist.Feign;
    ...
    class CocktailDBClientFallback implements CocktailDBClient {
        ...
        public CocktailDBResponse searchCocktails(String search) {
            ...
            cocktailDBResponse.setDrinks(cocktailEntities.stream().map(cocktailEntity -> {
                ...
                drinkResource.setStrImageSource(cocktailEntity.getStrImageSource());
                drinkResource.setStrInstructions(cocktailEntity.getStrInstructions());
                drinkResource.setStrGlass(cocktailEntity.getStrGlass());
